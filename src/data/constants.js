export const Bio = {
  ...
  roles: ["Software Engineer", "Cybersecurity Analyst Jr", "Programmer"],
  description:
...
export const skills = [
  {
    ...
    skills: [
      ...
      },
      {
        name: "Parrot OS",
        image:
          "https://commons.wikimedia.org/wiki/File:Parrotsec.png#/media/File:Parrotsec.png",
      },
      {
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: "SQL",
        image: "https://www.vectorlogo.zone/logos/sql/sql-icon.svg",
      },
      {
        name: "phpMyAdmin",
        image:
...
export const experiences = [
  {
    ...
    desc: "Working in the Cyber ​​Threat Intelligence (CybInt) department, implementing honeypots and developing a tool with python.",
    skills: [
      "Docker",
      "Ansible",
      "YAML",
  ...
  },
  {
    ...
    desc: "Student assistant with experience in web streaming services and broadcaster (college classes and hackathons)",
  ...
  },
  {
    ...
    desc: "Customer service, logistics and local sales",
    skills: ["SII billing system."],
  },
];
